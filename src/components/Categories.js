  ...
  return (
    <div className='flex-shrink space-x-0'>
      ...
      <div className="flex">
        ...
        <div className="img-hover-zoom--quick-zoom relative">
  ...
  <h1 className='absolute  left-32 right-0 bottom-6 font-sans font-normal text-3xl text-black  cursor-pointer  hover:underline decoration-violet-900 decoration-2'>Engagement Rings</h1>
        ...
        <div>
          ...
          <div className='flex' style={{ marginTop: '-50px', marginLeft: '-30px' }}>
            <div className="img-hover-zoom--quick-zoom relative">
              <img className='my-10 w-80 h-80 cursor-pointer' src={category5} alt="Category 5" />
              <h1 className='absolute  left-7 right-0 bottom-28 font-serif text-[#746274] cursor-pointer'>SHOP</h1>
              <h1 className='absolute  left-7 right-0 bottom-20 font-sans font-normal text-3xl text-black  cursor-pointer  hover:underline decoration-violet-900 decoration-2'>Earrings</h1>
            </div>
            <div className="img-hover-zoom--quick-zoom relative">
              <img className='w-80 h-80 my-10 mx-10 cursor-pointer' src={category6} alt="Category 6" />
              <h1 className='absolute  left-20 right-0 bottom-24 font-serif text-[#746274] cursor-pointer'>SHOP</h1>
              <h1 className='absolute  left-20 right-0 bottom-16 font-sans font-normal text-3xl text-black  cursor-pointer hover:underline decoration-violet-900 decoration-2'>Bracelets</h1>
            </div>
          </div>
        </div>
      </div>
